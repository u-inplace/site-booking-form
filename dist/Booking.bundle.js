...
/* harmony import */ var _webflow__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../webflow */ "./src/webflow.js");
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../constants */ "./src/booking/constants.js");
/* harmony import */ var _dom__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../dom */ "./src/booking/dom.js");
/* harmony import */ var _base__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./base */ "./src/booking/steps/base.js");
...
class AvailabilityStep extends _base__WEBPACK_IMPORTED_MODULE_6__["default"] {
  #calendar;
  /**
   * Openings for a day
   * @type {Opening[]}
  ...
  constructor() {
    super(_constants__WEBPACK_IMPORTED_MODULE_4__.STEP.Availability);
  }
  ...
  onActive() {
    ...
    this.#calendar = new _calendar_main__WEBPACK_IMPORTED_MODULE_1__["default"]('availability-cal', {
      postalCode: _dom__WEBPACK_IMPORTED_MODULE_5__["default"].postalCode.value,
      duration: _dom__WEBPACK_IMPORTED_MODULE_5__["default"].duration,
      recurrence: _dom__WEBPACK_IMPORTED_MODULE_5__["default"].occurrence
    }, this.onDayChange.bind(this));
    this.#createSummary(); // Load team profile from webflow collections

    this.team = _webflow__WEBPACK_IMPORTED_MODULE_3__.webflow.items({
      collectionId: _webflow__WEBPACK_IMPORTED_MODULE_3__.Collections.team
    })?.items;
  }
  /**
  ...
  #createSummary() {
    // Selected services
    const services = _dom__WEBPACK_IMPORTED_MODULE_5__["default"].getSelectedServices();
    Object.values(_constants__WEBPACK_IMPORTED_MODULE_4__.SERVICE).forEach(s => services.includes(s) ? _dom__WEBPACK_IMPORTED_MODULE_5__["default"].summary.activeService(s) : _dom__WEBPACK_IMPORTED_MODULE_5__["default"].summary.inactiveService(s));
    const {
      duration
    } = _dom__WEBPACK_IMPORTED_MODULE_5__["default"];
    _dom__WEBPACK_IMPORTED_MODULE_5__["default"].summary.duration = `${duration}h`;
    _dom__WEBPACK_IMPORTED_MODULE_5__["default"].summary.payment = `${duration} titres-services`;
    const {
      occurrence
    } = _dom__WEBPACK_IMPORTED_MODULE_5__["default"];
    _dom__WEBPACK_IMPORTED_MODULE_5__["default"].summary.occurrence = occurrence;
  }
  /**
  ...
  onDayChange(day, openings) {
    ...
    _dom__WEBPACK_IMPORTED_MODULE_5__["default"].calendar.openings.cleanUp(); // Hide Team block

    _dom__WEBPACK_IMPORTED_MODULE_5__["default"].calendar.team.hideBlock();
    if (lodash__WEBPACK_IMPORTED_MODULE_0___default().isEmpty(openings)) _dom__WEBPACK_IMPORTED_MODULE_5__["default"].calendar.openings.showWarning();else _dom__WEBPACK_IMPORTED_MODULE_5__["default"].calendar.openings.hideWarning();
  ...
  onStartTimeSelect(event) {
    ...
    _dom__WEBPACK_IMPORTED_MODULE_5__["default"].calendar.team.cleanUp();
    _dom__WEBPACK_IMPORTED_MODULE_5__["default"].calendar.team.showBlock();
    const start_time = event.target.value;
    const template = _dom__WEBPACK_IMPORTED_MODULE_5__["default"].calendar.team.memberTemplate;
...
/* harmony export */   "webflow": function() { return /* binding */ webflow; }
/* harmony export */ });
/* harmony import */ var webflow_api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! webflow-api */ "./node_modules/webflow-api/dist/index.js");
/* harmony import */ var webflow_api__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(webflow_api__WEBPACK_IMPORTED_MODULE_0__);

const Collections = {
  team: '6248c9f64a94f803de18ba67'
};
const webflow = new (webflow_api__WEBPACK_IMPORTED_MODULE_0___default())({
  token: '381ad749bc336b399bf43fafd0755a342125bbc8f4b869c5bcf7bd2a23a3ca54'
});
