...
const onSubmit = async event => {
  ...
  try {
    ...
    if (res.status >= 300) {
      logError(res);
      if (resJson?.errors?.sodexo_reference) _dom__WEBPACK_IMPORTED_MODULE_2__["default"].form.error.toast('toast-sodexo');else _dom__WEBPACK_IMPORTED_MODULE_2__["default"].form.error.toast('toast-submit-error');
    ...
    _dom__WEBPACK_IMPORTED_MODULE_2__["default"].form.error.toast('toast-submit-error');
    _dom__WEBPACK_IMPORTED_MODULE_2__["default"].form.onSubmitDone();
  }
};
/**
