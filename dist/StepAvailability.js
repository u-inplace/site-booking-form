...
/* harmony import */ var _helpers_dates__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../helpers/dates */ "./src/booking-flow/helpers/dates.js");
/* harmony import */ var _styles_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./styles.css */ "./src/booking-flow/controllers/calendar/styles.css");
...
class CalendarController {
  ...
  async getAvailability(weekStartDate) {
    ...
    const newEvents = lodash__WEBPACK_IMPORTED_MODULE_2___default().compact(avail?.data?.map(dateAvail => dateAvail.time_slots.flatMap(slot => slotToEvent(slot))));
...
/*!***************************************************!*\
  ...
  \***************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _controllers_calendar__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../controllers/calendar */ "./src/booking-flow/controllers/calendar/index.js");
...
class Step extends _controllers_step__WEBPACK_IMPORTED_MODULE_2__["default"] {
  ...
  constructor() {
    super(_controllers_sequence__WEBPACK_IMPORTED_MODULE_1__.STEP.Availability);
  }
  /**
   * @returns {boolean}
   */
  ...
  get isNextDisabled() {
    return !_helpers_dom__WEBPACK_IMPORTED_MODULE_3__["default"].getRadio('team-member', true);
  }
  ...
  init() {
    ...
    this.#calendar = new _controllers_calendar__WEBPACK_IMPORTED_MODULE_0__["default"]('availability-cal', {
  ...
  #createSummary() {
    ...
    Object.values(SERVICE).forEach(s => services.includes(s) ? DOM.summary.activeService(s) : DOM.summary.inactiveService(s));
    const {
      duration
    } = DOM;
  ...
  onDayChange(day, openings) {
    ...
    DOM.calendar.openings.cleanUp(); // Hide Team block

    DOM.calendar.team.hideBlock();
    if (_.isEmpty(openings)) DOM.calendar.openings.showWarning();else DOM.calendar.openings.hideWarning();
  ...
  onStartTimeSelect(event) {
    ...
    const template = DOM.calendar.team.memberTemplate; // Set start and end time on hidden inputs
