...
class Navigation {
  ...
  #updateNav() {
    document.getElementsByClassName('step-number')[this.#slider.current - 1].innerHTML = `Step ${this.#sequence.current}/${this.#sequence.current === _constants__WEBPACK_IMPORTED_MODULE_1__.STEP.Services ? '-' : this.#sequence.total}`;
  }
