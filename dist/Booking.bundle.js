...
const onSubmit = async event => {
  ...
  try {
    _dom__WEBPACK_IMPORTED_MODULE_2__["default"].form.onSubmit();
    const res = await fetch(url, {
      method: 'POST',
      headers: {
    ...
    if (res.status >= 300) {
      _dom__WEBPACK_IMPORTED_MODULE_2__["default"].form.error.title = 'Something went wrong';
      _dom__WEBPACK_IMPORTED_MODULE_2__["default"].form.error.detail = JSON.stringify(resJson);
      _dom__WEBPACK_IMPORTED_MODULE_2__["default"].form.error.toast();
      _dom__WEBPACK_IMPORTED_MODULE_2__["default"].form.onSubmitDone();
    } else {
      _dom__WEBPACK_IMPORTED_MODULE_2__["default"].form.done();
    }
  } catch (error) {
    _dom__WEBPACK_IMPORTED_MODULE_2__["default"].form.error.title = 'Something went very wrong';
    _dom__WEBPACK_IMPORTED_MODULE_2__["default"].form.error.detail = error.message;
    _dom__WEBPACK_IMPORTED_MODULE_2__["default"].form.error.toast();
    _dom__WEBPACK_IMPORTED_MODULE_2__["default"].form.onSubmitDone();
  }
};
